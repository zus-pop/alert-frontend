...
import { Button } from "@/components/ui/button"
import { ClockIcon, ChartBarIcon, BellIcon } from "lucide-react"

function Page() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] p-4">
      <Card className="w-full max-w-3xl shadow-lg">
        <CardContent className="flex flex-col items-center p-8 space-y-6 text-center">
          <div className="rounded-full bg-blue-100 p-4">
            <ChartBarIcon className="h-12 w-12 text-blue-600" />
          </div>
          
          <h1 className="text-3xl font-bold tracking-tight">Analytics Dashboard Coming Soon</h1>
          
          <p className="text-gray-500 text-lg max-w-md">
            We're working hard to build a comprehensive analytics dashboard to help you track student performance and alerts.
          </p>
          
          <div className="flex items-center gap-2 text-amber-600">
            <ClockIcon className="h-5 w-5" />
            <span className="font-medium">Expected release: Soon</span>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mt-6">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-medium mb-2">Performance Tracking</h3>
              <p className="text-sm text-gray-600">Track student performance across courses and semesters</p>
            </div>
            
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-medium mb-2">Alert Analytics</h3>
              <p className="text-sm text-gray-600">View detailed insights about alert patterns and response times</p>
            </div>
            
            <div className="bg-gray-50 p-4 rounded-lg">
              <h3 className="font-medium mb-2">Intervention Effectiveness</h3>
              <p className="text-sm text-gray-600">Measure the impact of your interventions and support</p>
            </div>
          </div>
